...
Game_1_score = score('http://www.vassarathletics.com/boxscore.aspx?path=msoc&id=7808')
Game_2_score = score('http://www.vassarathletics.com/boxscore.aspx?path=msoc&id=7809')
Game_3_score = score('http://www.vassarathletics.com/boxscore.aspx?path=msoc&id=7810')
Game_4_score = score('http://www.vassarathletics.com/boxscore.aspx?path=msoc&id=7811')
Game_5_score = score('http://www.vassarathletics.com/boxscore.aspx?path=msoc&id=7812')
Game_6_score = score('http://www.vassarathletics.com/boxscore.aspx?path=msoc&id=7813')
Game_7_score = score('http://www.vassarathletics.com/boxscore.aspx?path=msoc&id=7814')
Game_8_score = score('http://www.vassarathletics.com/boxscore.aspx?path=msoc&id=7815')
Game_9_score = score('http://www.vassarathletics.com/boxscore.aspx?path=msoc&id=7816')
Game_10_score = score('http://www.vassarathletics.com/boxscore.aspx?path=msoc&id=7817')
Game_11_score = score('http://www.vassarathletics.com/boxscore.aspx?path=msoc&id=7818')
Game_12_score = score('http://www.vassarathletics.com/boxscore.aspx?path=msoc&id=7819')
Game_13_score = score('http://www.vassarathletics.com/boxscore.aspx?path=msoc&id=7820')
Game_14_score = score('http://www.vassarathletics.com/boxscore.aspx?path=msoc&id=7821')
Game_15_score = score('http://www.vassarathletics.com/boxscore.aspx?path=msoc&id=7822')
Game_16_score = score('http://www.vassarathletics.com/boxscore.aspx?path=msoc&id=7823')
Game_17_score = score('http://www.vassarathletics.com/boxscore.aspx?path=msoc&id=7824')
Game_18_score = score('http://www.vassarathletics.com/boxscore.aspx?path=msoc&id=7825')
Game_19_score = score('http://www.vassarathletics.com/boxscore.aspx?path=msoc&id=7826')
Game_20_score = score('http://www.vassarathletics.com/boxscore.aspx?path=msoc&id=8413')


scores_2016 = (Game_1_score,Game_2_score,Game_3_score,Game_4_score,Game_5_score,Game_6_score,
          Game_7_score,
        Game_8_score,Game_9_score,Game_10_score,
        Game_11_score,Game_12_score,Game_13_score,Game_14_score,Game_15_score,Game_16_score,
        Game_17_score,Game_18_score,Game_19_score,Game_20_score)

Game_1_2015 = score('http://www.vassarathletics.com/boxscore.aspx?path=msoc&id=6683')
Game_2_2015 = score('http://www.vassarathletics.com/boxscore.aspx?path=msoc&id=6685')
Game_3_2015 = score('http://www.vassarathletics.com/boxscore.aspx?path=msoc&id=6684')
Game_4_2015 = score('http://www.vassarathletics.com/boxscore.aspx?path=msoc&id=6686')
Game_5_2015 = score('http://www.vassarathletics.com/boxscore.aspx?path=msoc&id=6687')
Game_6_2015 = score('http://www.vassarathletics.com/boxscore.aspx?path=msoc&id=6688')
Game_7_2015 = score('http://www.vassarathletics.com/boxscore.aspx?path=msoc&id=6689')
Game_8_2015 = score('http://www.vassarathletics.com/boxscore.aspx?path=msoc&id=6690')
Game_9_2015 = score('http://www.vassarathletics.com/boxscore.aspx?path=msoc&id=6691')
Game_10_2015 = score('http://www.vassarathletics.com/boxscore.aspx?path=msoc&id=6692')
Game_11_2015 = score('http://www.vassarathletics.com/boxscore.aspx?path=msoc&id=6693')
Game_12_2015 = score('http://www.vassarathletics.com/boxscore.aspx?path=msoc&id=6694')
Game_13_2015 = score('http://www.vassarathletics.com/boxscore.aspx?path=msoc&id=6695')
Game_14_2015 = score('http://www.vassarathletics.com/boxscore.aspx?path=msoc&id=6696')
Game_15_2015 = score('http://www.vassarathletics.com/boxscore.aspx?path=msoc&id=6697')
Game_16_2015 = score('http://www.vassarathletics.com/boxscore.aspx?path=msoc&id=6698')

scores_2015 = (Game_1_2015,Game_2_2015,Game_3_2015,Game_4_2015,Game_5_2015,
               Game_6_2015,Game_7_2015,Game_8_2015,Game_9_2015,Game_10_2015,
               Game_11_2015,Game_12_2015,Game_13_2015,Game_14_2015,Game_15_2015,
               Game_16_2015)



Game_1_2014 = score('http://www.vassarathletics.com/boxscore.aspx?path=msoc&id=5906')
Game_2_2014 = score('http://www.vassarathletics.com/boxscore.aspx?path=msoc&id=5907')
Game_3_2014 = score('http://www.vassarathletics.com/boxscore.aspx?path=msoc&id=5908')
Game_4_2014 = score('http://www.vassarathletics.com/boxscore.aspx?path=msoc&id=5909')
Game_5_2014 = score('http://www.vassarathletics.com/boxscore.aspx?path=msoc&id=5910')
Game_6_2014 = score('http://www.vassarathletics.com/boxscore.aspx?path=msoc&id=5911')
Game_7_2014 = score('http://www.vassarathletics.com/boxscore.aspx?path=msoc&id=5912')
Game_8_2014 = score('http://www.vassarathletics.com/boxscore.aspx?path=msoc&id=5913')
Game_9_2014 = score('http://www.vassarathletics.com/boxscore.aspx?path=msoc&id=5914')
Game_10_2014 = score('http://www.vassarathletics.com/boxscore.aspx?path=msoc&id=5915')
Game_11_2014 = score('http://www.vassarathletics.com/boxscore.aspx?path=msoc&id=5916')
Game_12_2014 = score('http://www.vassarathletics.com/boxscore.aspx?path=msoc&id=5917')
Game_13_2014 = score('http://www.vassarathletics.com/boxscore.aspx?path=msoc&id=5918')
Game_14_2014 = score('http://www.vassarathletics.com/boxscore.aspx?path=msoc&id=5919')
Game_15_2014 = score('http://www.vassarathletics.com/boxscore.aspx?path=msoc&id=5920')
Game_16_2014 = score('http://www.vassarathletics.com/boxscore.aspx?path=msoc&id=5921')
Game_17_2014 = score('http://www.vassarathletics.com/boxscore.aspx?path=msoc&id=5922')
Game_18_2014 = score('http://www.vassarathletics.com/boxscore.aspx?path=msoc&id=5923')

scores_2014= (Game_1_2014,Game_2_2014,Game_3_2014,Game_4_2014,Game_5_2014,
               Game_6_2014,Game_7_2014,Game_8_2014,Game_9_2014,Game_10_2014,
               Game_11_2014,Game_12_2014,Game_13_2014,Game_14_2014,Game_15_2014,
               Game_16_2014,Game_17_2014,Game_18_2014)


def scores_for_survival(data):
    time_holder = []
    binary = []
    win_lose = []
    z = 0
    ...
    for j in range(len(data)):
        ...
        q = 0
        for i in data[j]:
            if data[j][i].split('-')[1] == '1':
                time_holder.append(time_map(i))
                binary.append(1)
                break
            elif data[j][i].split('-')[1] != '1': 
                z += 1
            if z == len(data[j]):
                time_holder.append(90)
                binary.append(0)
                
        for i in data[j]:   
            if q == len(data[j])-1:
                if data[j][i].split('-')[0] > data[j][i].split('-')[1]:
                    win_lose.append(1)
                else: win_lose.append(0)
            q += 1
        
    df = pd.DataFrame(data = [time_holder,binary,win_lose]).T
    df.columns = ['Time','Scored','Win/Loss']
    return df

    #return time_holder,binary

df = scores_for_survival(scores_2016+scores_2015)